...
#permutations(n = 2,r=A,repeats.allowed = TRUE) # will need to do this for every single possible combination seen before
#permutations(n = 2,v=0:1,r=A,repeats.allowed = TRUE)
...
samplesizePWL1=sum(Ppart*Npart$Totaln)
samplesizePWL1
...
set.seed(1)
Npart=Expectedsamplesizenumberbit(n,r,WA)
samplesizePWL2=sum(Ppart*Npart$Totaln)
samplesizePWL2
...
set.seed(1)
Npart=Expectedsamplesizenumberbit(n,r,WA)
samplesizePWL3=sum(Ppart*Npart$Totaln)
samplesizePWL3
...
set.seed(1)
Npart=Expectedsamplesizenumberbit(n,r,WA)
samplesizePWL4=sum(Ppart*Npart$Totaln)
samplesizePWL4
...
set.seed(1)
Npart=Expectedsamplesizenumberbit(n,r,WA)
samplesizePWL5=sum(Ppart*Npart$Totaln)
samplesizePWL5
...
set.seed(1)
Npart=Expectedsamplesizenumberbit(n,r,WA)
samplesizePWL6=sum(Ppart*Npart$Totaln)
samplesizePWL6

#looking at conjunctive power
...
set.seed(1)
Npart=Expectedsamplesizenumberbit(n,r,WA)
samplesizeCPL1=sum(Ppart*Npart$Totaln)
samplesizeCPL1
...
set.seed(1)
Npart=Expectedsamplesizenumberbit(n,r,WA)
samplesizeCPL2=sum(Ppart*Npart$Totaln)
samplesizeCPL2
...
set.seed(1)
Npart=Expectedsamplesizenumberbit(n,r,WA)
samplesizeCPL3=sum(Ppart*Npart$Totaln)
samplesizeCPL3
...
set.seed(1)
Npart=Expectedsamplesizenumberbit(n,r,WA)
samplesizeCPL4=sum(Ppart*Npart$Totaln)
samplesizeCPL4
...
set.seed(1)
Npart=Expectedsamplesizenumberbit(n,r,WA)
samplesizeCPL5=sum(Ppart*Npart$Totaln)
samplesizeCPL5
...
set.seed(1)
Npart=Expectedsamplesizenumberbit(n,r,WA)
samplesizeCPL6=sum(Ppart*Npart$Totaln)
samplesizeCPL6
