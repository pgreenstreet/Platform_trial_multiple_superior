...
1-0.975^.5
Designfor1armPWP=Onearmdesign(1-0.975^.5,0.2,20,0.00001,-log(0.69),1)
Designfor1armPWP
...
SamplesizesepatePWPFWER=list("MaxsepatePWP"=MaxsepatePWP,"Line1sepatePWP"=Line1sepatePWP,"Line2sepatePWP"=Line2sepatePWP,
                        "Line3sepatePWP"=Line3sepatePWP,"Line4sepatePWP"=Line4sepatePWP,"Line5sepatePWP"=Line5sepatePWP
                        ,"Line6sepatePWP"=Line6sepatePWP)
save(SamplesizesepatePWPFWER,file="SamplesizesepatePWPFWER.RData")


Designfor1armTP=Onearmdesign(1-0.975^.5,1-sqrt(.8),20,0.00001,-log(0.69),1)
Designfor1armTP
...
SamplesizesepateTPFWER=list("MaxsepateTP"=MaxsepateTP,"Line1sepateTP"=Line1sepateTP,"Line2sepateTP"=Line2sepateTP,
                        "Line3sepateTP"=Line3sepateTP,"Line4sepateTP"=Line4sepateTP,"Line5sepateTP"=Line5sepateTP
                        ,"Line6sepateTP"=Line6sepateTP)
save(SamplesizesepateTPFWER,file="SamplesizesepateTPFWER.RData")
